  ...
  <div>
    <header class="header">
      <nav class="container flex flex-jc-sb flex-ai-c">
        <a
          class="header__logo flex flex-ai-c"
          href="/"
        >
          <svg
            width="124"
        ...
        <a
          href="#"
          class="header__hamburger mobile"
      ...
      <div
        class="container header__menu flex flex-jc-fe mobile"
        :class="{ 'fade-in' : isBurgerActive, 'fade-out' : !isBurgerActive }"
      >
        <svg
          width="330"
          height="330"
        ...
        >
          <path
            d="M-4.8842e-05 23H303.498L329.998 0V330H0L-4.8842e-05 23Z"
            fill="white"
          />
        </svg>
        <div>
    ...
    <modal-vue
      ...
      :class="{ 'fade-in' : isContactActive, 'fade-out' : !isContactActive }"
      @closeModal="toggleContactActive"
    >
      <contact-vue
        :display="display"
        @closeModal="toggleContactActive"
...
export default {
  ...
  created() {
    ...
    mql.addEventListener('change', this.$store.commit('setMobile', mql.matches));
  },
  methods: {
    toggleContactActive() {
      this.isContactActive = !this.isContactActive;

      if (this.isContactActive) {
        this.display = 'block';
      } else {
        this.display = 'none';
      }
